...
export function ResponseMessage({
  ...
  return (
    <div className={cn("flex gap-4", className)}>
      ...
      <div className="flex max-w-[min(100%,760px)] flex-col gap-3">
        {/* Content */}
        <div
          className={cn(
            "rounded-lg px-1 py-1 transition-all bg-transparent text-[16px] text-foreground leading-relaxed",
          ...
          {showThinking ? (
            <div className="flex items-center gap-1 min-h-[44px]">
              ...
              <ShimmeringText
                ...
                className="font-[var(--chat-font)] font-medium text-[16px] text-foreground"
              />
            </div>
          ) : (
